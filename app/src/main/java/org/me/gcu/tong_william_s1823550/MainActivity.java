...
public class MainActivity extends FragmentActivity implements View.OnClickListener, OnMapReadyCallback {
    ...
    public void onClick(View aview) {
        ...
        //Button corresponds to different types of Incidents (Current, Planned & Roadworks)
        if (aview != null) {
            int id = aview.getId();
            mMap.clear();
            if (id == R.id.RwButton) {
        ...
        public void run() {
            ...
            try {
                ...
                while (eventType != XmlPullParser.END_DOCUMENT) {
                    ...
                    //edit
                    /*if (xpp.getName().contains(itemSearch.getText().toString()) || xpp.getName().contains(itemSearch.getText().toString())) {
                        alist.add(roadwork);
                    }*/
                    // Get the next event
                    eventType = xpp.next();
